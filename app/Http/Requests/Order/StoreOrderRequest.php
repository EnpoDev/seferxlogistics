...
class StoreOrderRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'payment_method' => ['nullable', 'in:cash,card,online,pluxee,edenred,multinet,metropol,tokenflex,setcard'],
            'payment_methods' => ['nullable', 'json'],
            'print_mode' => ['nullable', 'in:auto,manual,none'],
    ...
    public function messages(): array
    {
        return [
            ...
            'payment_method.in' => 'Gecersiz odeme yontemi.',
            'payment_methods.json' => 'Parcali odeme verisi gecersiz formatta.',
            'zone_id.exists' => 'Secilen mahalle bulunamadi.',
