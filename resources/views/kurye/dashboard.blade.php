...
<div class="p-4 space-y-6 slide-up">
    ...
    <div class="grid grid-cols-3 gap-3">
        <a href="{{ route('kurye.pool') }}" class="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-xl p-4 flex flex-col items-center space-y-2 card-interactive">
            ...
            <span class="text-sm font-medium text-black dark:text-white">Siparis Al</span>
        </a>
        ...
        <a href="{{ route('kurye.orders') }}" class="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-xl p-4 flex flex-col items-center space-y-2 card-interactive">
            ...
            <span class="text-sm font-medium text-black dark:text-white">Siparislerim</span>
        </a>

        <a href="{{ route('kurye.schedule') }}" class="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-xl p-4 flex flex-col items-center space-y-2 card-interactive">
            <div class="w-12 h-12 bg-purple-100 dark:bg-purple-900/30 rounded-full flex items-center justify-center">
                <svg class="w-6 h-6 text-purple-600 dark:text-purple-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z"/>
                </svg>
            </div>
            <span class="text-sm font-medium text-black dark:text-white">Takvim</span>
        </a>
    </div>
