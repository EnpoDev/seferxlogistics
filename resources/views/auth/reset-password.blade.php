...
<head>
    ...
    <title>Şifre Sıfırla - SeferX Lojistik</title>
    ...
    <div class="min-h-screen flex items-center justify-center p-6">
        <div class="w-full max-w-md">
            ...
            <div class="text-center mb-8">
                ...
                <h1 class="text-3xl font-bold text-black dark:text-white">Şifre Sıfırla</h1>
                <p class="text-gray-600 dark:text-gray-400 mt-2">Yeni şifrenizi belirleyin</p>
            </div>
