            ...
            <div class="p-6 space-y-6">
                <div>
                    <label class="flex items-center space-x-3">
                        ...
                        <span class="text-sm font-medium text-black dark:text-white">Havuz sistemini aktif et</span>
                    </label>
                </div>

                <div>
                    <label class="block text-sm font-medium text-black dark:text-white mb-2">Havuz bekleme süresi (dakika)</label>
                    <input type="number" class="w-full px-4 py-2 bg-gray-100 dark:bg-gray-900 text-black dark:text-white rounded-lg border border-gray-200 dark:border-gray-800 focus:outline-none focus:border-black dark:focus:border-white">
                </div>

                <div>
                    <label class="flex items-center space-x-3">
                        <input type="checkbox" class="w-5 h-5 rounded border-gray-300">
                        <span class="text-sm font-medium text-black dark:text-white">Otomatik havuzdan atama</span>
                    </label>
                </div>
            </div>
        </div>
