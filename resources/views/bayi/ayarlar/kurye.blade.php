            ...
            <div class="p-6 space-y-6">
                <div>
                    <label class="flex items-center space-x-3">
                        ...
                        <span class="text-sm font-medium text-black dark:text-white">Otomatik kurye ataması</span>
                    </label>
                </div>
                ...
                <div>
                    <label class="flex items-center space-x-3">
                        <input type="checkbox" class="w-5 h-5 rounded border-gray-300">
                        <span class="text-sm font-medium text-black dark:text-white">Kurye mesai saati kontrolü</span>
                    </label>
                </div>
