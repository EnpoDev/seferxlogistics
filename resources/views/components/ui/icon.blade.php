...
@php
    $icons = [
        ...
        'truck' => '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 17a2 2 0 11-4 0 2 2 0 014 0zm10 0a2 2 0 11-4 0 2 2 0 014 0z"/><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M1 11V8a2 2 0 012-2h9l3 4h3a2 2 0 012 2v3"/><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M1 11h11m5 0h4"/>',
        ...
        'motorcycle' => '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 17a3 3 0 100 6 3 3 0 000-6zm14 0a3 3 0 100 6 3 3 0 000-6zM5 17l2-7h6l4 7M9 10V5l3 2"/>',
    ];

    $iconPath = $icons[$name] ?? $icons['info'];
@endphp
